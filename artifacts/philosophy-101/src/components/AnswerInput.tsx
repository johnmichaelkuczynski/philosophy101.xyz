  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <textarea
        ...
        disabled={disabled}
        className="w-full min-h-[180px] p-5 bg-card border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-2xl leading-relaxed resize-y"
      />
