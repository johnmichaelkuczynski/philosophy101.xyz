  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 h-full border-r border-border p-12 overflow-hidden flex flex-col relative">
        ...
        <h1 className="text-3xl font-serif text-primary mb-8">1.1 What is philosophy?</h1>
        ...
        <div className="prose prose-sm max-w-none text-foreground/80 space-y-6">
          <h2 className="font-serif text-2xl text-primary">Reasoned inquiry</h2>
          <p>
            Philosophy is the discipline that asks fundamental questions and tries to answer them through careful reasoning — rather than by experiment, revelation, or authority. Its questions lie underneath the other fields.
          </p>
          <p>
            A physicist asks how matter behaves; a philosopher asks what it even means to know anything at all. Where science can take some things for granted, philosophy steps back and examines the assumptions themselves.
          </p>
            ...
            {phase < 2 || phase >= 4 ? (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">How is philosophy different from science?</div>
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">What makes a question philosophical?</div>
                  <div className="px-3 py-1.5 rounded-full border border-border text-sm text-primary bg-muted/30">Why does philosophy rely so much on argument?</div>
                </div>
                ...
                {phase === 2 ? (
                  ...
                  >
                    <p className="text-foreground font-medium mb-6">
                      "All humans are mortal; Socrates is human; so Socrates is mortal." Is this argument valid, and what makes it so?
                    </p>
