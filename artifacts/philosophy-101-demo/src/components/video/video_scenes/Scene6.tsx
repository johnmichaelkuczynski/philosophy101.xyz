        ...
        {phase >= 2 && phase < 5 ? (
            ...
            <div className="space-y-4">
              ...
              >
                <div>
                  ...
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.1 — Arguments, validity, and soundness</h4>
              ...
              >
                <div>
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Homework</div>
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.2 — Reasoning, fallacies, and method</h4>
                  <div className="text-sm text-muted-foreground">4 problems</div>
                </div>
                <div className="flex items-center space-x-6">
                  <div className="text-right">
          ...
          >
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 mb-6 relative overflow-hidden">
              ...
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q1. Can a valid argument have a false conclusion? Explain.</h3>
              
              <div className="mb-6 max-w-2xl">
                <div className="text-xs text-muted-foreground mb-2">Your answer:</div>
                <div className="px-6 py-3 bg-muted/30 border border-border rounded-lg text-base">Yes — if at least one premise is false. Validity only guarantees the conclusion when the premises are all true.</div>
              </div>
                ...
                {phase >= 6 && (
                  ...
                  >
                    ...
                    <div className="text-sm text-blue-900 leading-relaxed">
                      <StreamingText text="Correct. A valid argument can have a false conclusion when one of its premises is false; validity only guarantees a true conclusion if the premises are all true. Clearly stated." delay={0} />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 opacity-50">
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q2. Give an example of inductive reasoning...</h3>
