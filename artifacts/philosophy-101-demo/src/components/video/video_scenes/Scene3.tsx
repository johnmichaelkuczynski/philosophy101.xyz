    ...
    >
      ...
      <div className="w-1/2 h-full border-r border-border p-12 overflow-hidden flex flex-col relative opacity-50">
        ...
        <div className="prose prose-sm max-w-none text-foreground/80 space-y-6">
          ...
          <p>Philosophy is the discipline that asks fundamental questions and tries to answer them through careful reasoning — rather than by experiment, revelation, or authority. Its questions lie underneath the other fields.</p>
        </div>
      </div>
        ...
        <div className="flex-1 p-8 relative flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto space-y-6 flex flex-col">
            ...
            {phase >= 3 && (
              ...
              >
                <StreamingText text="Great question. Science settles questions by observation and experiment, but philosophy works on questions no experiment can decide — like what counts as knowledge, or whether we have free will. It examines the assumptions the sciences take for granted, using argument as its tool." delay={0} />
              </motion.div>
            )}
          </div>
          ...
          <div className="mt-6 w-full min-h-24 border border-border rounded-xl bg-background p-3 flex items-end shadow-inner relative z-10">
            <div className="w-full flex justify-between items-center pr-2">
              <div className="text-foreground text-[15px] font-medium pl-2 relative w-full h-full flex items-center">
                {phase === 1 && <TypewriterText text="How is philosophy different from science?" speed={25} />}
                {phase >= 2 && phase < 4 && <span className="text-muted-foreground font-normal">Ask a question about this section...</span>}
                {phase >= 4 && <TypewriterText text="So what makes a question philosophical?" speed={20} />}
